...
\begin{resumo}
 ...
 %Currently, there is a great demand for specialized professionals in IT and similar areas, and it is perceived worldwide a shortage of qualified professionals. This problem occurs partially due to a lack of interest in technical training on the part of children and young people, often due to a misconception that these areas are difficult and/or uninteresting. Focusing on this aspect, this project aims to develop a low-cost system that implements the game of chess using robotic arms. This system can be presented to children and young people in educational fairs and similar events with the aim of instigating interest in learning by introducing basic concepts  in the areas of computing, electrical engineering and control systems engineering.

 %Atualmente, existe uma grande procura por funcionários especializados em Tecnologia da Informação (TI) e áreas similares, sendo percebida no mundo todo uma grande carência de profissionais para atuar nessas áreas. Esse problema ocorre parcialmente devido a um desinteresse à capacitação técnica por parte de crianças e jovens, frequentemente devido a uma concepção de que essas áreas são difíceis e/ou desinteressantes. Com o foco neste aspecto, esse projeto visa desenvolver um sistema de baixo custo que implementa um jogo de xadrez por meio de manipuladores robóticos. Esse sistema pode ser apresentado para crianças e jovens em feiras científicas e outros eventos, com o objetivo de instigar o interesse pelo aprendizado ao introduzir conceitos básicos de computação, engenharia elétrica e controle de sistemas.
